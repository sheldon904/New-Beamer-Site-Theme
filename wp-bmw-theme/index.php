    ...
    <div class="container contact__container">
        <div class="contact__info">
            ...
            <div class="contact__info-item">
                <div><strong>Address:</strong><br><a href="https://www.google.com/maps/search/?api=1&query=2027+Mayport+Rd+Jacksonville+FL+32233" target="_blank" rel="noopener noreferrer">2027 Mayport Rd, Jacksonville, FL 32233</a></div>
            </div>
            <div class="contact__info-item">
                <div><strong>Email:</strong><br><a href="mailto:bavarianrennsport@gmail.com">bavarianrennsport@gmail.com</a></div>
            </div>
            <div class="contact__info-item">
                <div><strong>Phone:</strong><br><a href="tel:+19042709390">(904) 270-9390</a></div>
            </div>
        </div>
